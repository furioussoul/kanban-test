...
import { r as resolveCliName, t as formatCliCommand } from "./command-format-CDHXQh1_.js";
import { v as DEFAULT_BOOTSTRAP_FILENAME } from "./agent-scope-C2k6BQnt.js";
...
import { b as waitForGatewayReachable, f as openUrl, g as resolveControlUiLinks, i as detectBrowserOpenSupport, m as probeGatewayReachable, o as formatControlUiSshHint } from "./onboard-helpers-CUuJedqj.js";
...
import { n as gatewayInstallErrorHint, t as buildGatewayInstallPlan } from "./daemon-install-helpers-dGw0Tw0h.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-CWMm3E4l.js").then((n) => n.r);
