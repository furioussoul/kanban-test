...
import { n as replaceCliName, r as resolveCliName } from "./command-format-CDHXQh1_.js";
...
import { n as resolveCliChannelOptions } from "./channel-options-hQ5PicN2.js";
import { t as getSubCliCommandsWithSubcommands } from "./register.subclis-Czpw6tQN.js";
import { a as registerProgramCommands, r as getCoreCliCommandsWithSubcommands } from "./command-registry-BaoDjP--.js";
import { r as setProgramContext } from "./program-context-DMkrV4MF.js";
import { t as forceFreePort } from "./ports-Dv-7eOvd.js";
import { n as formatCliBannerLine, r as hasEmittedCliBanner, t as emitCliBanner } from "./banner-GGiuL9No.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-B1E1VZjw.js").then((n) => n.t);
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-kBpNWaw_.js").then((n) => n.n);
