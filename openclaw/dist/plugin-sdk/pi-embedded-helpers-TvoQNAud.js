...
import { n as loadConfig, o as writeConfigFile, t as createConfigIO, z as getBlockedNetworkModeReason } from "./config-VBpsqf75.js";
import { H as resolveUserPath, Y as truncateUtf16Safe, c as CHANNEL_IDS, i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-C2adF5U4.js";
import { i as parseBooleanValue, t as formatCliCommand } from "./command-format-DgW0zcnY.js";
import { D as runExec, P as openBoundaryFile, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME, z as resolvePathViaExistingAncestorSync } from "./agent-scope-C3RYg0D_.js";
import { A as acquireSessionWriteLock, H as canonicalizeMainSessionAlias, U as resolveAgentMainSessionKey } from "./sessions-CGHocoSr.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-D0xt6lgD.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-CAudg7_g.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-DKimSo4o.js";
import { t as SsrFBlockedError } from "./ssrf-D07_rJxG.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-lPqzUCM0.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-CPCyDgZZ.js";
import { A as resolveWritablePathWithinRoot, B as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, C as ensureChromeExtensionRelayServer, D as DEFAULT_UPLOAD_DIR, E as DEFAULT_TRACE_DIR, F as DEFAULT_AI_SNAPSHOT_MAX_CHARS, I as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, L as DEFAULT_BROWSER_EVALUATE_ENABLED, M as normalizeBrowserFormField, N as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, O as resolveExistingPathsWithinRoot, P as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, R as DEFAULT_OPENCLAW_BROWSER_COLOR, T as DEFAULT_DOWNLOAD_DIR, V as isLoopbackHost, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as DEFAULT_OPENCLAW_BROWSER_ENABLED } from "./chrome-C3vTc1nR.js";
import { i as saveMediaBuffer, t as ensureMediaDir } from "./store-CRM8Dq1H.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DhkSFVqt.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DhkSFVqt.js")).closePlaywrightBrowserConnection();
		} catch {}
